...
import GDLogoFintech from "./../assets/images/GD-fintech-bg-faded.png";
...
const PortfolioDashboard = () => {
   ...
   const sxSunbird = {
      position          :  "relative",
      top               :  designFlat ? {base:"0px", lg:"-10px"} : "-250px",
   ...
   const sxD1CardDash = {
	...
	return (
		<>
            ...
            {/* Portfolio 2019 */}
				<GridItem area="four" className="areaFour portfolio2019Dash"
            ...
            {/* Software Skills */}
            <GridItem area="five" className="areaFive softwareSkillsDash"
            ...
            {/* Styleguide */}
            <GridItem area="six" className="areaSix styleguideDash"
